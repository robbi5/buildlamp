...
void lightning() {
  ...
  for(int i = 0 ; i <= crackles; i +=1) { 
    ...
    strip.setPixelColor(random(0,maxPixels), a - (b/20));
    strip.setPixelColor(random(0,maxPixels), strip.Color(10,30,10+r));
    strip.show();
    delay(random(30,100));                            
  } 
    variate();
  ...
  for(int j = 0 ; j <= crackles; j +=1) { 
    ...
    strip.setBrightness(brightness);
    strip.setPixelColor(random(0,maxPixels), a + (b/20));
    strip.setPixelColor(random(0,maxPixels), strip.Color(10,255-r,10+r));
    strip.show();
    delay(random(10,50));                            
  } 
